...
Quantum Sand is an everything app, including an educational art-game-storytelling platform. Written in React, Rust, Ruby-on-Rails, Elixir, Phoenix, Python, C++ and Qml. Blender is used for the artwork.
