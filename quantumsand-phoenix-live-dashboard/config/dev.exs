...
config :live_dashboard, LiveDashboardWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "yFVSNvMhWrqDWcDHp9T1aeZ657pGWnDr97mi24pWBtx3MpGWTpBeq6H15PUfKsbQ",
  watchers: [
...
config :live_dashboard, LiveDashboardWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/live_dashboard_web/router\.ex$"E,
      ~r"lib/live_dashboard_web/(controllers|live|components)/.*\.(ex|heex)$"E
    ]
  ]
