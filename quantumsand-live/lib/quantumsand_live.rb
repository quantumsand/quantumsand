class QuantumsandLive
  ...
  def initialize
    ...
    @git_repos_github = [
      ...
      "pop-os/cosmic-applet-host",
      "pop-os/cosmic-applet-template",
      "pop-os/cosmic-application-template",
    ...
    @git_repos_osmocom_org_gitea = [
      ...
      "retronetworking/isdn4linux",
      "retronetworking/capisuite",
      "retronetworking/ant-phone",
    ...
    @git_repos_iws_uni_stuttgart_de = [
      ...
      "dumux-repositories/dumux-test-installation"
    ]
    ...
    @git_repos_gitlab = [
      ...
      "ohwr/project/fmc-mtlu",
      "ohwr/project/fmc-mtlu-gw",
      ...
      "ohwr/level-conversion/conv-ttl-rs485/conv-ttl-rs485-hw",
      "ohwr/level-conversion/conv-ttl-rs485/conv-ttl-rs485-tst",
      ...
      "ohwr/project/fmc-adc-250m-16b-4cha",
      "ohwr/project/fmc-adc-2k24b8cha",
      "ohwr/project/fmc-adc-400k18b4cha-iso-gw",
      "ohwr/project/fmc-adc-400k18b4cha-iso-sw",
      "ohwr/project/fmc-adc-500m14b4cha",
      "ohwr/project/fmc-bus",
      ...
      "ohwr/project/fmc-sfp-4cha",
      "ohwr/project/fmc-sw",
      "ohwr/project/fmc-tdc",
      "ohwr/project/fmc-tdc-1ns-5cha-gw",
      ...
      "ohwr/project/wr-std",
      "ohwr/project/wr-starting-kit",
      "ohwr/project/wr-switch-hdl",
    ...
    @git_repos_code_videolan_org = [
      ...
      "videolan/medialibrary-test-samples",
    ...
    @git_repos_gnome_gitlab = [
      ...
      "GNOME/gexiv2",
      "GNOME/ghex",
      "GNOME/gimp-book-painting",
      "GNOME/gimp-data-extras",
      "GNOME/gimp-help",
      "GNOME/gimp-perl",
      "GNOME/gitg",
      "GNOME/gjs",
  ...
  def self.build
    ...
    gentoo_use_flags = %w(kde gnome gtk gtk3 gtk4 plymouth wallpapers wacom networkmanager smart
                          ...
                          ntfsprogs ntfsdecrypt mount-ntfs arm64ec georeplication grafana -branding -java).join(' ')
